<script>
	...
	import FeedAll from '$lib/Concepts/FeedAll.svelte';
</script>

<svelte:head>
	<title>Concepts \ Steffen Wold</title>
	<meta property="og:title" content="Concepts \ Steffen Wold" />
	<meta property="og:site_name" content="Steffen Wold" />
	<meta property="og:url" content="https://steffen.id/concepts" />
