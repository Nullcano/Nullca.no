...
<svelte:head>
	<title>Academy Journal \ Steffen Wold</title>
	<meta property="og:title" content="Academy Journal \ Steffen Wold" />
	<meta property="og:site_name" content="Steffen Wold" />
	<meta property="og:url" content="https://steffen.id/journal" />
	<meta property="og:description" content="Ikomm Academy 2022." />
