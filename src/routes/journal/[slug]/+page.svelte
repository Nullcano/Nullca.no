...
<svelte:head>
	<title>{item.title} \ Academy Journal \ Steffen Wold</title>
	<meta property="og:title" content="{item.title} \ Academy Journal \ Steffen Wold" />
...
<div class="button cta" on:click={() => goto("/journal")}>
