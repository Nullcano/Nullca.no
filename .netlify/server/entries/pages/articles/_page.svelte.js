...
const FeedAll = (0, import_chunks.c)(($$result, $$props, $$bindings, slots) => {
  let entries = import_data.d.filter((entry) => entry.type === "articles").sort((a, b) => b.date - a.date);
...
const Page = (0, import_chunks.c)(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>Articles \\ Steffen Wold</title>`, ""}<meta property="${"og:title"}" content="${"Articles \\ Steffen Wold"}" data-svelte="svelte-1nauryn"><meta property="${"og:site_name"}" content="${"Steffen Wold"}" data-svelte="svelte-1nauryn"><meta property="${"og:url"}" content="${"https://steffen.id/articles"}" data-svelte="svelte-1nauryn"><meta property="${"og:description"}" content="${"Articles."}" data-svelte="svelte-1nauryn"><meta property="${"og:type"}" content="${"website"}" data-svelte="svelte-1nauryn"><meta property="${"og:image"}" content="${""}" data-svelte="svelte-1nauryn">`, ""}

<div class="${"page"}">${(0, import_chunks.v)(import_PageTitle.P, "PageTitle").$$render($$result, { title: "Articles" }, {}, {})}
