...
const FeedAll = (0, import_chunks.c)(($$result, $$props, $$bindings, slots) => {
  let entries = import_data.d.filter((entry) => entry.type === "concepts").sort((a, b) => b.date - a.date);
...
const Page = (0, import_chunks.c)(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>Concepts \\ Steffen Wold</title>`, ""}<meta property="${"og:title"}" content="${"Concepts \\ Steffen Wold"}" data-svelte="svelte-s1wi83"><meta property="${"og:site_name"}" content="${"Steffen Wold"}" data-svelte="svelte-s1wi83"><meta property="${"og:url"}" content="${"https://steffen.id/concepts"}" data-svelte="svelte-s1wi83"><meta property="${"og:description"}" content="${"Concepts."}" data-svelte="svelte-s1wi83"><meta property="${"og:type"}" content="${"website"}" data-svelte="svelte-s1wi83"><meta property="${"og:image"}" content="${""}" data-svelte="svelte-s1wi83">`, ""}

<div class="${"page"}">${(0, import_chunks.v)(import_PageTitle.P, "PageTitle").$$render($$result, { title: "Concepts" }, {}, {})}
